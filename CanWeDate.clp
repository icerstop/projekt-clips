...
(defrule its-my-physician ""
   ...
   =>
   (assert (UI-state (display PhysicianQuestion)
...
(defrule crazy ""
   (logical (no-relatede-subtype BFSibling))
   =>
   (assert (UI-state (display AreYouCrazyQuestion)
...
(defrule respond-absolutely-not ""
   ...
   (logical (relatede-yes-blood Blood1))
...
(defrule respond-captain ""
   (or
   (logical (related-no-blood Blood1))
...
(defrule respond-game-on ""
   ...
   =>
   (assert (UI-state (display GameOnRespond)
                     (state final))))
...
>>>>>>> 5648f97231a00a6460d100ba72986c6c1d0badfc
